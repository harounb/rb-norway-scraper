    ...
    describe("requiring scraper", function() {
        ...
        describe("and initing with html containing multiple moves", function() {
            it("will return a data object containing move data of valid format", function() {
                ...
                expect(scraper.getData().moves[0]).toEqual(expectedMoves.moves[0]);
                expect(scraper.getData().moves[1]).toEqual(expectedMoves.moves[1]);
                expect(scraper.getData().moves[2]).toEqual(expectedMoves.moves[2]);
                expect(scraper.getData().moves[3]).toEqual(expectedMoves.moves[3]);
                expect(scraper.getData().moves[4]).toEqual(expectedMoves.moves[4]);
